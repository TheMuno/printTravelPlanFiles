...
function setupDays(locations, $daySlide, dayNum, daysDate) {
    ...
    locations.forEach((location, num) => {
        ...
        if (lat && lng) {
            ...
            populateDays($daySlide, dayNum, daysDate, num, title, dayEventName, $dayEventsTable, $dayEventsTableTitleCell, $dayEventsTableAddressCell); 
        }
    });
}

function populateDays($daySlide, dayNum, daysDate, num, title, dayEventName, $dayEventsTable, $dayEventsTableTitleCell, $dayEventsTableAddressCell) {
